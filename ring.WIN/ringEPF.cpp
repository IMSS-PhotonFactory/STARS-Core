...
Attach attachPtr[] =
{
 -1,"PF:Ring",          "PFRing_DATETIME","DATETIME"  , &array_double[0],&pre_array_double[0],CF_DOUBLE,1
,-1,"PF:Ring",          "PFRing_DCCT"    ,"DCCT"      , &array_double[1],&pre_array_double[1],CF_DOUBLE,1
,-1,"PF:Ring",          "PFRing_Energy"  ,"Energy"    , &array_double[2],&pre_array_double[2],CF_DOUBLE,1
,-1,"PF:Ring",          "PFRing_Vacuum"  ,"Vacuum"    , &array_double[3],&pre_array_double[3],CF_DOUBLE,1
,-1,"PF:Ring",          "PFRing_Lifetime","Lifetime"  , &array_double[4],&pre_array_double[4],CF_DOUBLE,1
,-1,"PF:Ring:PFRing_Mode",     "DESC"    ,"Status"    , &array_char[0]  ,&pre_array_char[0],CF_CHAR,40
,-1,"PF:Ring:PFRing_ModeText", "DESC"    ,"StatusText", &array_char[1]  ,&pre_array_char[1],CF_CHAR,40
,-1,"PF:Ring:PFRing_Status",   "DESC"    ,"Message"   , &array_char[2]  ,&pre_array_char[2],CF_CHAR,40
};
