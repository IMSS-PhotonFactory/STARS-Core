...
#define DEVSRVNAME "/BLCO/EPICS2TINE"
...
Attach attachPtr[] =
{
 -1,"PFAR:Ring",          "PFARRing_DATETIME","DATETIME"  , &array_double[0],&pre_array_double[0],CF_DOUBLE,1
,-1,"PFAR:Ring",          "PFARRing_DCCT"    ,"DCCT"      , &array_double[1],&pre_array_double[1],CF_DOUBLE,1
,-1,"PFAR:Ring",          "PFARRing_Energy"  ,"Energy"    , &array_double[2],&pre_array_double[2],CF_DOUBLE,1
,-1,"PFAR:Ring",          "PFARRing_Vacuum"  ,"Vacuum"    , &array_double[3],&pre_array_double[3],CF_DOUBLE,1
,-1,"PFAR:Ring",          "PFARRing_Lifetime","Lifetime"  , &array_double[4],&pre_array_double[4],CF_DOUBLE,1
,-1,"PFAR:Ring:PFARRing_Mode",     "DESC"    ,"Status"    , &array_char[0]  ,&pre_array_char[0],CF_CHAR,40
,-1,"PFAR:Ring:PFARRing_ModeText", "DESC"    ,"StatusText", &array_char[1]  ,&pre_array_char[1],CF_CHAR,40
,-1,"PFAR:Ring:PFARRing_Status",   "DESC"    ,"Message"   , &array_char[2]  ,&pre_array_char[2],CF_CHAR,40
};
...
void PostSystemInit(void)
{
  ...
  for(i=0;i<ATTACH_NUM;i++){
	...
	sprintf(devname,"%s/%s",DEVSRVNAME,attachPtr[i].devicename);
