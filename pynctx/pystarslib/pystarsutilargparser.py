...
from pystarslib import pystarsutilconfig
...
class PyStarsUtilArgParser():
    ...
    # Initialize:
    #----------------------------------------------------------------
    def __init__(self, numberOfStarsServer=1, numberOfDeviceServer=1, useConfigFile=True, useLogOutput=True, useRawEnable=False, useDebugLevel=False, useLogOutputLevel=False):
        self._parser = None
        self._error = ''
